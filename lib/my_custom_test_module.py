...
def run_module():
    ...
    module_args = dict(
            ...
            ingredient=dict(type='str', required=True),
    ...
    if module.params['augment'] == False:
        ...
        # Potato Salad Suggestions
        result['message'] = "Welcome to the Potato Salad Recommendator v3.2"
        result['message'] = ""
        result['message'] = "First Ingredient is: " + module.params['ingredient']
        result['message'] = "Based on the parameters you chose: the best salad to go with is:"
